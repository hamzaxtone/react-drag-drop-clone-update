      ...
      <div id="settings" className="css-1up8n9n ">
        <div className="layers-container h-100 d-flex flex-column justify-content-between overflow-auto">
          <div className='layers-top'>
            <div className="css-1sr1lb8">
              ...
              <div className="css-hsza6h">
                <svg onClick={toggleLayersClick} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" width="1em" height="1em">
          ...
          <div className='px-3 layers-bottom d-block'>
            <h6 className='w-100 d-flex justify-content-between'> Total Budget: <span className="badge rounded-pill bg-success">{totalBudget} Rs</span></h6>
          </div>
        </div>
      </div>
    </>
