...
<div className="css-wcwwis">
   <div className="css-7z6edo">
      <div className="css-39gffh">
        <a className="text-normal d-block h2 text-white" href="" rel="noreferrer" target="_blank">
        {/* <img src="https://demo.lidojs.com/assets/logo.png" alt="" className="css-1jxic4p" /> */}
        React
        </a></div>
   </div>
